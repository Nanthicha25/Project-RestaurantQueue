...
public void decreasegoods(String namefood,int quantity,String comment)
{
   try {
        R1=new File("BillandCart");
        R2=new FileReader(R1);
      ...
      for(int i=0;i<datafilecart.size();i++)
      {String text[]=datafilecart.get(i).split(",");
      int oldquantity=Integer.parseInt(text[2]);
       if(text[0].equals(namefood)&&oldquantity>quantity&&text[3].equals(comment))
