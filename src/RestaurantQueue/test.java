...
try {
  shop.Createmenu("Maincourse", "P5000", "Salmon", 199);
  shop.Addstock("Maincourse", "P5000", "Salmon");
  shop.Updatepromotion("Maincourse", "P5000", "Salmon", 999);
  shop.Addcart("Salmon", 2, null);
   shop.Updatepromotion("Maincourse", "P5000", "Salmon", 500);
} catch (Exception e) {
 System.out.println(e.getMessage());
}
try {//รหัสอาหารซ้ำ
shop.Createmenu("Maincourse", "P5000", "Salad", 199);
} catch (Exception e) {
 System.out.println(e.getMessage());
}
try {//ชื่ออาหารซ้ำ
shop.Createmenu("Maincourse", "P0500", "Salmon", 199);
} catch (Exception e) {
 System.out.println(e.getMessage());
}
try {//ชื่อและรหัสอาหารซ้ำ
shop.Createmenu("Maincourse", "P5000", "Salmon", 199);
} catch (Exception e) {
 System.out.println(e.getMessage());
}
try {//เปลี่ยนชื่ออาหาร
shop.Createmenu("Maincourse", "P5000", "Sushi", 199);
} catch (Exception e) {
 System.out.println(e.getMessage());
}
try {//อาหารซ้ำกับmaincourse
shop.Createmenu("Dessert", "P5000", "Salmon", 199);
//shop.Addqueue();
shop.Deletemenu("P5000");
shop.Changequantitycart("Cake", 1, "No Sweet");
shop.Updatepromotion("Dessert", "P001", "Cake", 1000);
shop.Changequantitycart("Cake", 4, "No Sweet");

shop.Addcart("Cake", 4, "No Sweet");
shop.Changequantitycart("Cake", 1, "No Sweet");
shop.Updatepromotion("Dessert", "P001", "Cake", 100);
shop.Createmenu("Maincourse", "P9000", "BarB Q", 199);
shop.Addcart("Chocolate", 2, "");
} catch (Exception e) {
 System.out.println(e.getMessage());
}
}}
