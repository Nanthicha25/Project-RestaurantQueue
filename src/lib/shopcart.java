...
public class shopcart {
    ...
    public void Setquantity(String namefood, int quantity,String comment) throws InvalidOperationException {
        if (quantity< 0 ) {
            throw new InvalidOperationException("Invalid quantity");
        }
        checkRep();
       updatecart.Changequantity(namefood,quantity,comment);
