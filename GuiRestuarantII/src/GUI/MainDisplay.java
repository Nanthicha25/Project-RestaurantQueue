...
public class MainDisplay extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        shortAddMenu = new javax.swing.JPanel();
        ...
        InsideInputPanel.setLayout(new java.awt.BorderLayout());
        ...
        InsideInputPanel.add(jPanel25, java.awt.BorderLayout.PAGE_START);
        ...
        InsideInputPanel.add(jPanel26, java.awt.BorderLayout.PAGE_END);

        jPanel6.setLayout(new java.awt.GridLayout(0, 4));

        shortAddMenu.setBackground(new java.awt.Color(204, 204, 255));

        jButton8.setBackground(new java.awt.Color(110, 186, 140));
        jButton8.setFont(new java.awt.Font("Segoe UI", 1, 100)); // NOI18N
        ...
        javax.swing.GroupLayout shortAddMenuLayout = new javax.swing.GroupLayout(shortAddMenu);
        shortAddMenu.setLayout(shortAddMenuLayout);
        shortAddMenuLayout.setHorizontalGroup(
            shortAddMenuLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(shortAddMenuLayout.createSequentialGroup()
                .addGap(20, 20, 20)
                .addComponent(jButton8, javax.swing.GroupLayout.DEFAULT_SIZE, 195, Short.MAX_VALUE)
                .addGap(24, 24, 24))
        );
        shortAddMenuLayout.setVerticalGroup(
            shortAddMenuLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(shortAddMenuLayout.createSequentialGroup()
                .addContainerGap()
        ...
        jPanel6.add(shortAddMenu);

        InsideInputPanel.add(jPanel6, java.awt.BorderLayout.CENTER);

        jScrollPane1.setViewportView(InsideInputPanel);
        ...
        MiddlePanel.add(InputPanel, "card6");
    ...
    try (BufferedReader br = new BufferedReader(new FileReader(fileName))) {
        ...
        while ((line = br.readLine()) != null) {
            ...
            if (parts.length == 5) {
                ...
                shop.Createmenu(type, id, name, price, imagePath);
                lib.food foodItem = shop.getAllmenu().get(shop.getAllmenu().size() - 1);

                MenuItemPanel itemGUI = new MenuItemPanel(foodItem);
                jPanel6.add(itemGUI);
            }
        }
        jPanel6.revalidate();
    ...
    try (FileWriter fw = new FileWriter(fileName, true);
        ...
        out.println(Name + "," + Id + "," + price + "," + type + "," + imagePath);
    ...
    private javax.swing.JPanel shortAddMenu;
